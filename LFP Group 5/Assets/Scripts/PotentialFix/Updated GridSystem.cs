...
public class GridCell
{
    ...
    // The physical boundaries of this grid cell.
    public BoundsInt GridBounds { get; private set; }

    // True when something is occupying this cell and the player
    // should not be allowed to move onto it.
    public bool IsBlocked { get; private set; }

    // Changes whether this cell is blocked.
    ...
    // Returns the centre position of the cell in world space.
    public Vector2 Center()
    {
        return GridBounds.center;
    }
...
////////////////////////////////////////////// FIX //////////////////////////////////////////////////
    ...
    // Finds a cell at the given grid position and changes
    // whether that cell is blocked or available.
...
////////////////////////////////////////////// FIX //////////////////////////////////////////////////
        ...
        public GridCell GetGridCell(int column, int row)
        {
            ...
            // Find the GridCell that corresponds to the requested
            // column and row.
            ...
            // If the cell is occupied by an obstacle, pretend
            // that the cell does not exist for movement purposes.
            //
            // This allows the existing Player script to handle
            // blocked cells because Player already checks for null.
